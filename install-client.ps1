...
Invoke-WebRequest -Uri "https://cdn.lu2000luk.com/pointhole/client/client.exe?commit=1d6e584" -OutFile $clientPath -UseBasicParsing # add last commit to the url to bust the cache
