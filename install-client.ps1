...
Invoke-WebRequest -Uri "https://cdn.lu2000luk.com/pointhole/client/client.exe?commit=0fcba51" -OutFile $clientPath -UseBasicParsing # add last commit to the url to bust the cache
