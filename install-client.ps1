...
Invoke-WebRequest -Uri "https://cdn.lu2000luk.com/pointhole/client/client.exe?commit=2a22115" -OutFile $clientPath -UseBasicParsing # add last commit to the url to bust the cache
