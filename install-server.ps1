...
Invoke-WebRequest -Uri "https://cdn.lu2000luk.com/pointhole/server/server.exe?commit=1d6e584" -OutFile $serverPath -UseBasicParsing # add last commit to the url to bust the cache
